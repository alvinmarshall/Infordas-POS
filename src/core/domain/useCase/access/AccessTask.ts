 ...
 */
@injectable()
export class AccessTask extends BaseUseCase<any, IAccess> {
  ...
  protected generateUseCase(input?: IAccess | undefined): Promise<any> {
    if (input == null) throw new Error("access params can't be null");
    return this.userRepository.setUserAccess(input);
  }
}
